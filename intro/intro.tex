...
\begin{itemize}
    \item \textbf{Chapter 2}: Here the method used to find literature is decribed, and the screening criteria for articles.
    \item \textbf{Chapter 3}: This chapter will answer the question in the first objective by reviewing the literature.
    \item \textbf{Chapter 4}: This chapter will answer the question in second objective by reviewing the literature and begin to answer the question in the third objective.
    ...
    \item \textbf{Chapter 7}: Here the review will be wrapped up and concluded.
\end{itemize}
